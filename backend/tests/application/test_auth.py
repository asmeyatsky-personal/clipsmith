...
class TestRegisterUserUseCase:
    def test_register_user_success(self, user_repo, password_helper):
        use_case = RegisterUserUseCase(user_repo, password_helper)
    ...
    def test_register_user_duplicate_email(self, user_repo, password_helper):
        use_case = RegisterUserUseCase(user_repo, password_helper)
...
class TestAuthenticateUserUseCase:
    def test_login_success(self, user_repo, password_helper, jwt_helper):
        register_use_case = RegisterUserUseCase(user_repo, password_helper)
        ...
        auth_use_case = AuthenticateUserUseCase(user_repo, password_helper, jwt_helper)
    ...
    def test_login_wrong_password(self, user_repo, password_helper, jwt_helper):
        register_use_case = RegisterUserUseCase(user_repo, password_helper)
        register_dto = RegisterRequestDTO(
    ...
    def test_login_nonexistent_user(self, user_repo, password_helper, jwt_helper):
        auth_use_case = AuthenticateUserUseCase(user_repo, password_helper, jwt_helper)
        login_dto = LoginRequestDTO(
